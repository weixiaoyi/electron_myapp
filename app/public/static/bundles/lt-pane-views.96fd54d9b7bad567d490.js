webpackJsonp([1], {
  ...
  314: function(e, t, i) {
    ...
    function n(e, t, i, n) {
      return null !== e
        ? l.intersectPolygonAndHalfplane(e, a.halfplaneThroughPoint(a.lineThroughPoints(t, i), n))
        : null;
    }
    function r(e, t) {
      return e.length === t;
      ...
      (_ = (function() {
        function e(e, t) {
          (this._data = null),
            ...
            (this._backHittestResult = t || new d(d.MOVEPOINT_BACKGROUND));
        }
        return (
          (e.prototype.setData = function(e) {
            this._data = e;
          ...
          (e.prototype.draw = function(e) {
            ...
            null === this._data ||
              ...
              r(this._data.points, 4) &&
                ...
                (a = s[2]),
                (o = s[3]),
                this._data.skipLines || this._data.skipTopLine || this._extendAndDrawLineSegment(e, a, o),
          ...
          (e.prototype.hitTest = function(e) {
            ...
            if (
              ...
              return s;
            if (r(this._data.points, 4) && !this._data.skipTopLine) {
              if (
                ((a = this._data.points),
                (o = a[2]),
                (l = a[3]),
                null !== (h = this._extendAndHitTestLineSegment(e, o, l)))
              )
                return h;
              if (
                this._data.showMidline &&
                ...
                null !== (p = this._extendAndHitTestLineSegment(e, d, c)))
              )
                return p;
            }
          ...
          (e.prototype._extendAndDrawLineSegment = function(e, t, i) {
            ...
            null !== n && h.drawLine(e, n[0].x, n[0].y, n[1].x, n[1].y);
          }),
          (e.prototype._extendAndHitTestLineSegment = function(e, t, i) {
            var n,
              r = this._extendAndClipLineSegment(t, i);
            return null !== r && ((n = o.distanceToSegment(r[0], r[1], e)), n.distance <= 3)
              ? this._hittestResult
              : null;
          }),
          (e.prototype._extendAndClipLineSegment = function(e, t) {
            var i = s.ensureNotNull(this._data);
            return c.extendAndClipLineSegment(e, t, i.width, i.height, i.extendleft, i.extendright);
          }),
          (e.prototype._drawBackground = function(e, t) {
            ...
            if (
              ...
              for (e.beginPath(), e.moveTo(r[0].x, r[0].y), l = 1; l < r.length; l++) e.lineTo(r[l].x, r[l].y);
  ...
  481: function(e, t) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.splitThousands = i);
  },
  491: function(e, t, i) {
    'use strict';
    var n, r, s;
    ...
    (n.prototype.setData = function(e) {
      ...
      (n.prototype.hitTest = function(e) {
        return null === this._data || 0 === this._data.points.length
          ...
          : this._adapter._editable && e.x >= this._cache.bodyRight && e.x < this._cache.quantityRight
          ? new o(o.CUSTOM, {
  ...
  911: function(e, t, i) {
    ...
    function r(e, t) {
      h.call(this, e, t),
        (this._clockWhite = _('prediction-clock-white', TradingView.wrapUrl('images/prediction-clock-white.png'))),
        (this._clockBlack = _('prediction-clock-black', TradingView.wrapUrl('images/prediction-clock-black.png'))),
        (this._successIcon = _('prediction-success-white', TradingView.wrapUrl('images/prediction-success-white.png'))),
        (this._failureIcon = _('prediction-failure-white', TradingView.wrapUrl('images/prediction-failure-white.png'))),
  ...
  913: function(e, t, i) {
    ...
    function r(e, t, i) {
      o.call(this, e, t),
        (this._image = c('price_label', TradingView.wrapUrl('images/price_label.png'))),
        (this._rendererCache = {}),
        (this._invalidated = !0),
