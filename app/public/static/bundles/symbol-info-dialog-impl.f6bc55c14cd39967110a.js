webpackJsonp([7], {
  ...
  182: function(e, t, n) {
    ...
    var i, r;
    Object.defineProperty(t, '__esModule', { value: !0 }), (i = n(2)), (r = n(153)), (t.Body = o);
  },
  183: function(e, t, n) {
    'use strict';
    var o, i, r, s;
  ...
  184: function(e, t, n) {
    ...
    var i, r;
    Object.defineProperty(t, '__esModule', { value: !0 }), (i = n(2)), (r = n(154)), (t.Footer = o);
  },
  185: function(e, t, n) {
    'use strict';
    function o(e) {
  ...
  187: function(e, t, n) {
    ...
    function o(e) {
      var t,
        ...
        d = s(
          r.dialog,
          ((t = {}), (t[c] = !!c), (t[r.rounded] = o), (t[r.shadowed] = u), (t[r.animated] = r.animated), t)
        ),
    ...
    var i, r, s;
    Object.defineProperty(t, '__esModule', { value: !0 }), (i = n(2)), (r = n(157)), (s = n(26)), (t.Dialog = o);
  },
  188: function(e, t, n) {
    'use strict';
    function o() {
  ...
  431: function(e, t, n) {
    (function(e, o) {
      ...
      function r(e) {
        E || ((E = document.createElement('div')), document.body.appendChild(E)), C.render(D.createElement(L, e), E);
      }
      function s(e) {
        var t,
          n = w;
      ...
      function a(e) {
        return y(new S(e).entries()).join('<br>');
      }
      function u(e) {
        return e || '-';
      }
        ...
        for (n = 0; n < t.length; n++)
          (o = t[n].propName) in e &&
            ...
            'minmove2' === o && e.minmove2 > 0 && !e.fractional && e.pricescale
              ? ((t[n].value = new x(e.pricescale / i).format(i / e.pricescale)), (t[n].title = $.t('Pip Size')))
      ...
      function d(e) {
        var t, n;
        return e > O.minutesPerDay && (e -= O.minutesPerDay), (t = e % 60), (n = (e - t) / 60), P(n, 2) + ':' + P(t, 2);
      }
      function p(e) {
        ...
        return Object.keys(t)
          .reduce(function(e, n) {
            var o,
              i = t[n].sort(),
              r = n.split('-'),
              s = O.get_minutes_from_hhmm(r[0]),
              a = O.get_minutes_from_hhmm(r[1]),
              u = s >= a;
            return (
              1 === i.length
      ...
      var E,
        b = n(97),
        w = n(226).availableTimezones,
        x = n(41).PriceFormatter,
        M = n(64),
        D = n(2),
        C = n(55),
        L = n(1105).SymbolInfoDialog,
        S = n(480).ExchangeSession,
        O = n(67),
        P = n(41).numberToStringWithLeadingZero,
        N = [2, 3, 4, 5, 6, 7, 1].map(function(t) {
          return e.weekdaysMin(t - 1);
        }),
        W = RegExp(N.join('|')),
        T = N.reduce(function(e, t, n) {
          return (e[t] = n + 1), e;
        }, {});
      ...
      (d = (function(e) {
        ...
        return (
          ...
          (t.prototype.render = function() {
            return r.createElement(
              s.PopupDialog,
              { isOpened: this.props.isOpened, onClickOutside: this.props.onClose },
